...
public class RESTfulApi {
    ...
    public Map<String, Object> getTestGetApi(@PathVariable Integer id) {
        return dataMap.get(id);
    }

    @DeleteMapping("/testApi/{id}")
    ...
    @PostMapping("/testApi")
    public String getTestPostApi(@RequestBody Map<String, Object> data) {
    ...
    @PutMapping("/testApi")
    public String getTestPutAPi(@RequestBody Map<String, Object> data) {
